...
import com.example.blueboxpro.Process.RollpitchCalculator
...
class CaptorListener(
    ...
    private fun updateCompass() {
        if (hasGravity && hasGeomagnetic) {
            val attitude= RollpitchCalculator.calculatePitchRoll(gravityData, geomagneticData)
            if (attitude != null) {
                processor.pitch = attitude.first
                processor.roll = attitude.second
            }
